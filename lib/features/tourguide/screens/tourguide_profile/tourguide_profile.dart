...
class TourguideProfileScreen extends StatelessWidget {
  const TourguideProfileScreen(
      {super.key, required this.image, this.onTapBookNow});
  final String image;
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const ReadMoreText(
                    "Welcome, everyone! I'm [Ahmed Youssef], and I'll be your guide on this incredible journey. I'm so excited to share my passion for this place with you!",
                    trimLines: 4,
                  ...
                  const Row(
                    children: [
                      ...
                      SizedBox(width: CSizes.sm),
                      Text("Arabic , English and French ")
                    ],
                  ),
                  const SizedBox(height: CSizes.spaceBtwItems),
                  const Row(
